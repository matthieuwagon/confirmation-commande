...
const G2026 = {
  ...
  INDUS_QUATTRO: {
    prixBase: 15900,
    configurations: { Base: 15900, "Chef Atelier": 15900 },
    options: {
      structure: { "Bois clair — S3*": 250 },
      fond:      { "Plein": 900 },
      ecran:     { "Fixe": 400, "Orientable": 500 },
...
const G2025 = {
  ...
  DUO: {
    prixBase: 13950,
    configurations: { Base: 13950, Vide: 12350, Haute: 13220, Individuel: 13280, Ouverte: 10710, Visio: 14590 },
    options: {
      structure: { "Bois clair — S3*": 250 },
      fond:      { "Plein": 900 },
      habillage: { A: 420, B: 610, C: 660, D: 790, E: 1090, F: 1940 },
  ...
  QUATTRO: {
    prixBase: 15950,
    configurations: { Base: 15950, Vide: 14410, Haute: 15955, Individuel: 15730, Ouverte: 12670, Visio: 16650 },
    options: {
      structure: { "Bois clair — S3*": 250 },
      fond:      { "Plein": 900 },
      habillage: { A: 630, B: 930, C: 1150, D: 1390, E: 1950, F: 3390 },
  ...
  SIXO: {
    prixBase: 18950,
    configurations: { Base: 18950, Visio: 17410 },
    options: {
      structure: { "Bois clair — S3*": 250 },
      fond:      { "Plein": 900 },
      banquette: { B: 560, C: 630, D: 910, E: 1790, F: 3890 },
  ...
  INDUS_QUATTRO: {
    prixBase: 14900,
    configurations: { Base: 14900, "Chef Atelier": 15900 },
    options: {
      structure: { "Bois clair — S3*": 250 },
      fond:      { "Plein": 900 },
      ecran:     { "Fixe": 400, "Orientable": 500 },
